...
<head>
    ...
    <title>{{ config('xelsaas.app_name') }}</title>
...
<div id="navigation" class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{ route('home') }}"><b>{{ config('xelsaas.app_name') }}</b></a>
        </div>
...
<div id="headerwrap">
    <div class="container">
        <div class="row centered">
            <div class="col-lg-12">
                <h1>{{ config('xelsaas.app_name') }}</h1>
                <h3>A <a href="https://laravel.com/">Laravel</a> 5 web application and REST API builder!</h3>
                <h3><a href="{{ url('https://github.com/gregoriohc/xelsaas') }}" class="btn btn-lg btn-success">View on Github!</a></h3>
            </div>
            <div class="col-lg-2">
